...
class Model:
    """
    original source code - "https://github.com/PreferredAI/cornac/blob/master/cornac/models/wmf/wmf.py"
    """
    ...
    def _build_graph(self):
        self.ratings = tf.compat.v1.placeholder(
        ...
        loss_2 = self.lambda_u * tf.nn.l2_loss(self.U) + self.lambda_v * tf.nn.l2_loss(
            V_batch
        )
        ...
        gvs = optimizer.compute_gradients(
            self.loss, var_list=tf.compat.v1.trainable_variables()
        )
